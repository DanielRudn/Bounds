...
public abstract class MapType {
	...
	public MapType(int type, Random random, Player player, MapGenerator generator)
	{
		this.type = type;
		rng = random;
